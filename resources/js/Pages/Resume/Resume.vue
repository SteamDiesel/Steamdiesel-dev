<template>
	<div
		class="
			...
			max-w-6xl
			mx-auto
			print:p-0 print:w-full print:flex
			sm:flex sm:p-14
			tracking-wide
		"
	>
		<Head>
			<title>Resume - Jason Law</title>
			<meta property="og:image" content="/images/splat.png" />
		</Head>
		<!-- Left Column -->
		<div class="w-full print:w-3/4 sm:w-3/4 pr-4">
			<!-- Header -->
			<div class="pt-4 flex">
				<div class="w-28">
				...
				<div class="pl-4">
					...
					<h2 class="text-xl print:text-lg font-bold text-orange-600">
						{{ position }}
					</h2>
					<div class="flex text-gray-500 text-sm print:text-xs mt-1">
			...
			<!-- Profile -->
			<div class="pt-10">
				<h2 class="text-lg font-bold text-orange-600">Profile</h2>
				<div class="border-l-2 pl-8 text-sm print:text-xs">
					<div
			...
			<div class="pt-10 pr-4">
				<h2 class="text-lg font-bold text-orange-600">Experience</h2>
		...
		<!-- Right Column -->
		<div class="w-full print:block print:w-1/4 sm:w-1/4">
			<div class="border-l-2 pl-4">
				<div class="mb-10">
					<h2 class="text-md font-semibold text-orange-600 mb-2">
						Details
					</h2>
					<div
						v-for="(item, index) in details"
						:key="index"
						class="text-sm print:text-xs mb-2 print:mb-1"
					>
						<a
							v-if="item.url"
							target="blank"
				...
				<div class="w-24">
					<div class="flex mx-auto my-auto">
						<svg class="h-16 text-orange-100" viewBox="0 0 640 512">
							<path
								fill="currentColor"
...
export default {
	data() {
		return {
			...
			profile: [
				"Frontend web developer with extensive experience working with VueJS since 2018, HTML, TailwindCSS and BootstrapCSS.",
				"I've built several Progressive Web Apps with VueJS",
				"Backend developer with Laravel PHP since 2017",
				"Good understanding of OOP, TDD, SOLID & DRY principles.",
				"Comfortable writing and consuming RESTful APIs, including the OAuth2 spec and Stripe.",
				"I have built and launched multiple small products including finance CRMs, micro-blog apps, chrome extensions and websites.",
				"Recent professional web development experience building an Admin Dashboard for internal company use with Agile methodology.",
				"Confident in interviewing customers and stakeholders to uncover business needs and potential features.",
			...
			lists: [
				...
				{
					title: "Frameworks",
					content: ["Laravel", "VueJS", "Tailwind CSS", "Bootstrap"],
				},

				{
					title: "Dev Systems",
					content: ["Jira", "Asana", "Slack"],
				},
				{
					title: "Other Skills",
					content: [
				...
				// 		"RG146 Tier 2 - General Advice (General Insurance)",
				// 	],
				// },
			],
			experience: [
					...
					roles: [
						{
							...
							tenure: "7m",
							description: [
								"Laravel with Vuejs (via inertiajs), using laravel nova as the dashboard. Tailwind CSS and using the Tailwind UI component library. Deployed on Digital Ocean via laravel Forge.",
								"I was responsible for implementing the support dashboard for administrative investigation and changes within the main SAAS product. I was responsible for specifying the RESTful API for the offshore development team.",
								"Working in the support team to understand the need for tools to improve support response times and capabilities.",
								"Each week, I was doing the full Agile iterative cycle of gathering requirements from the team, prioritizing and building features, testing and gathering feedback then implementing improvements.",
								"Connected to the API via OAuth2, the Laravel system makes read actions from the endpoints then translate, sanitize and then serve that data to the dashboard view.",
								"Working on this project as the sole developer, I was responsible for UI and UX, design and layout and implementation decisions.",
								"This was a dual responsibility role, I started at OurProperty as a Support agent and when I demonstrated my ability as a web developer I was asked to build the dashboard.",
							],
						},
						{
						...
						},
						{
							...
							description: [
								...
								"I built this product to solve my own problems because there were no good CRMs in the finance broker space, so I wanted to build the perfect one.",
								"The development of BDFI has been a passion project, which I've used to improve my own coding skills.",
								"Using Laravel to host the RESTful API with access control and subscription billing. The front end client was a PWA built in VueJS that could be installed and work like a native application.",
								"I chose to build this platform as 'Offline First', with assumptions that internet connection would be unreliable in many forseeable business cases.",
							],
						},
						{
							...
							tenure: "5y",
							description: [
								"After studying via online courses (udemy and laracasts) since 2017, I began working on side projects and offering to build projects for friends and family.",
								"I've built various projects for work and enjoyment.",
								"I am most proud of the memorial site I built for kingkai.org, which I built as a simple VueJS Progressive Web App with a Laravel API for access control, database queries and business logic.",
					...
					roles: [
						{
							...
							tenure: "3m",
							description: [
								"In my spare time I built a chrome extension to try and supplement some of the shortcomings of the application.",
								...
								"Selling a pre MVP beta product against well established industry standard products under considerable time and target pressures.",
...

						{
							...
							description: [
								...
								"I established the Zoho CRM into the business where there was previously no CRM or formal sales process.",
								...
								"I was employed in the start-up Property Sales division of Webster's Wealth Partners, initially established to sell house and land packages, townhouses and units to First Home Buyers. Before shutting down, this division began to service investors.",
								"Webster's is a group of Financial planners, Accountants and Property Managers. These businesses are either related or in service to wealth creation and investment.",
							],
						},
						{
							position:
...

				{
					...
					roles: [
						{
							position: "Sales & Finance - Business Manager",
							employer: "AutoApprove",
							from: "September 2018",
							to: "March 2020",
							tenure: "1y7m",
							description: [
								"A business manager in a motor dealership sees every single client and tries to sell finance and insurance products.",
								"I had a deep and broad understanding of sales and finance by this stage and so I put them to good use. I helped to close more deals and inject more energy into this sleepy little dealership.",
								"Beginning July 2019, when Auto Approve was acquired by Auto Sports Group Limited, I transitioned to full-time Account Manager for the brokerage, maintaining its referral-partner dealerships in Brisbane.",
...

						{
							...
							employer: "MTA Insurance",
							from: "January 2012",
							to: "January 2013",
							tenure: "1y",
							description: [
								"This employer was a training academy, intended to give training and experience to cadet Business Managers by placing them into dealerships as cheap locums.",
								"The role was intended to be temporary and last no longer than 18 months before the cadet became ready to enter the market on their own.",
							],
						},
					],
				},
				{
					career: "Sales & Service - Telco",
					tenure: "3 years",
					roles: [
						{
							position: "Business Customer Support",
							employer: "Telstra",
							from: "July 2010",
							to: "July 2011",
							tenure: "1y",
							description: [
								"Customer support role. Contact centre based in Ann Street assisting Telstra Business Clients with fixed line and mobile faults and provisioning.",
								"At this time Telstra had a reputation for call centre transfer hell. Thankfully however, we had more freedom and time to fix client issues and give our clients a better experience in this department.",
...

						{
							...
							tenure: "2y1m",
							description: [
								"Inbound sales calls assisting people who would respond to direct mail, TV and radio advertising. My goal was to close the sale on the first call and provision the service over the phone.",
							],
						},
					],
				},
				{
					career: "Sales - Pumping and Irrigation",
					tenure: "4 years",
					roles: [
						{
							position: "Advanced Technical Sales",
							employer: "McCracken's Water Services",
							from: "March 2006",
							to: "May 2008",
							tenure: "2y2m",
							description: [
								"Sales of household and agricultural pumps and plumbing accessories. This role was primarily phone-based to assist customers with expert knowledge on pump selection.",
								"Success in this role was dependent on the level of product knowledge and conveying confidence in selection to the customer.",
							],
						},
						{
							position: "Technical Sales",
							employer: "The Electrical Workshop",
							from: "March 2003",
							to: "August 2004",
							tenure: "2y1m",
							description: [
								"I started my sales career as a Junior retail trainee. In this role, I sold water pumps, electric motors, power tools and equipment to consumer and trade customers.",
								"Sales of household and agricultural pumps and plumbing accessories. Success in this role was dependent on the level of product knowledge and a can-do attitude.",
							],
						},
					],
				},
