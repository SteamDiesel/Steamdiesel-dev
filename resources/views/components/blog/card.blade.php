<article class="md:grid md:grid-cols-4 md:items-baseline">
    <div class="md:col-span-3 group relative flex flex-col items-start">
        <h2 class="
            ...
            <div class="
    					...
    					"></div>
            <a href="/static/blog/{{$post->slug}}"><span class="
    							absolute
    							-inset-y-6 -inset-x-4
    							z-20
    							sm:-inset-x-6 sm:rounded-2xl
    						"></span><span class="relative z-10">{{ $post->title }}</span></a>
        </h2>
        <time class="
    					md:hidden
    					relative
                    ...
                    class="
    							...
    							bg-zinc-200
    							dark:bg-zinc-500
    						"></span></span>{{ $post->updated_at }}</time>
        <p class="
    					relative
    					z-10
    					mt-2
        ...
        <a href="/static/blog/{{$post->slug}}" aria-hidden="true" class="
    					relative
    					z-10
    					mt-4
    					flex
    ...
    <time class="
    				...
    				text-sm text-zinc-400
    				dark:text-zinc-500
    			" datetime="2022-09-05">{{ $post->updated_at }}</time>
</article>
